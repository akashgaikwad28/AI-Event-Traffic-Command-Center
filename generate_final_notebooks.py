...
m"""
    ...
    with open(
        "notebooks/production/15_live_incident_simulation.ipynb", "w", encoding="utf-8"
    ) as f:
        nbf.write(nb, f)
...
plt.show()"""
    ...
    with open(
        "notebooks/production/16_model_failure_analysis.ipynb", "w", encoding="utf-8"
    ) as f:
        nbf.write(nb, f)
