...
class InferenceService:
    ...
    def _load_model(self):
        try:
            ...
            logger.warning(f"Model not found at {self.model_path}. Using heuristic fallback for demo.")
    ...
    def predict_gori(self, features: dict) -> float:
        ...
        """
        logger.info(f"Received inference request for coordinates: {features.get('latitude')}, {features.get('longitude')}")
