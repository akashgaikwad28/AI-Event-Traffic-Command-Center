...
"""),
        ...
        new_code_cell("""from sklearn.ensemble import RandomForestRegressor, RandomForestClassifier
...
"""),
        ...
        new_code_cell("""os.makedirs(ARTIFACTS_DIR, exist_ok=True)
