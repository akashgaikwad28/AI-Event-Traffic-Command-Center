...
class ExplainabilityEngine:
    ...
    async def explain_incident(self, incident_id: str, query: str, raw_context: Dict[str, Any]) -> Tuple[str, float, list[str]]:
        """
        ...
        safe_context = context_grounding_engine.build_incident_context(incident_id, raw_context)
